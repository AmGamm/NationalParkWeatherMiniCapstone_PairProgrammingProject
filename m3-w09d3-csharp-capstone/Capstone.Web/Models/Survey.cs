...
namespace Capstone.Web.Models
{
    public class Survey
    {
        ...
        public static List<SelectListItem> ParksAvailable
        {//tfr
            get
            {
                return new List<SelectListItem>()
                {
                    ...
                    new SelectListItem { Text = "Mount Rainer National Park", Value = "MRNP" },
        ...
        public static List<SelectListItem> StatesAvailable
        {
            get
            {
                return new List<SelectListItem>()
